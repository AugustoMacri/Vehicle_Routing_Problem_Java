#!/usr/bin/env python3
"""
Script para validação do algoritmo AEMMT nas instâncias C101-C109.
Executa 10 vezes cada instância e armazena resultados em results_validation_C1/.
...
def run_validation():
    ...
    print("\n" + "=" * 60)
    print("VALIDAÇÃO AEMMT - INSTÂNCIAS C1 (C101-C109)")
    print("=" * 60 + "\n")
