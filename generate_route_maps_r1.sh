...
# Script para gerar mapas de rotas das execuções R1 (rotas iniciais e finais)
# Similar ao usado para C1

echo "=========================================="
echo "Gerador de Mapas de Rotas - R1"
echo "=========================================="
...
if [ ! -d "$RESULTS_DIR" ]; then
    ...
    echo "Execute primeiro: python3 scripts/run_validation_r1.py"
    exit 1
fi
...
for instance in R101 R102 R103 R104 R105 R106 R107 R108 R109; do
...
echo "Mapas salvos em: results_validation_R1/[INSTANCE]/route_maps/"
echo "=========================================="
